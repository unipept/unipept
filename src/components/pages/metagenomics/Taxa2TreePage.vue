<template>
    <v-container>
        ...
        <h3 class="font-weight-light">Visualizes a stream of taxon IDs using the Unipept <Initialism>API</Initialism></h3>
        
        <v-divider class="my-2" />

        <p>
            The <Code>umgap taxa2tree</Code> command, similar to the <Code>unipept taxa2tree</Code> command, takes one or more taxon 
        ...
        <HeaderBodyCard id="usage" title="usage">
            <p>
                The input is given in a <Initialism>FASTA</Initialism> format on <i>standard input</i>. Each <Initialism>FASTA</Initialism> record contains one taxon ID. A HTML file 
                is written to <i>standard output</i> containing a visualization of the taxonomic tree containing all these taxa. 
                With <Code>-u</Code>, a <Initialism>URL</Initialism> to the visualization hosted online is printed instead.
            </p>
...
const usageParameters = [    
    ...
    { name: "-u / --url", description: "Host the result online and return the URL" }
];
</script>
