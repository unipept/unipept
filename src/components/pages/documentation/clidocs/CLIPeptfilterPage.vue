    ...
    <v-container>
        ...
        >
            <p>
                ...
                with a length lower than 5 or higher than 50 are removed. The length filter can be changed by using the <r-link to="#options" router>--minlen</r-link>
                and <r-link to="#options" router>--maxlen</r-link> parameters. Peptides can also be filtered based on whether or not they lack or contain certain amino
                acids. This can be done with the <r-link to="#options" router>--lacks</r-link> and <r-link to="#options" router>--contains</r-link> parameters.
            </p>
        </header-body-card>
        ...
        >
            <p>
                The <inline-code>peptfilter</inline-code> command supports input in a fasta-like format (for example generated by the <r-link to="/clidocs/prot2pept" router>prot2pept command</r-link>).
