<template>
    <v-container>
        ...
        <header-body-card
            ...
            large-title
        >
            <h2>--minlen <span class="text-body-small text-grey-darken-2">Specify minimum length</span></h2>
            ...
            <h2>--maxlen <span class="text-body-small text-grey-darken-2">Specify maximum length</span></h2>
            ...
            <h2>--contains / -c <span class="text-body-small text-grey-darken-2">Specify mandatory amino acids</span></h2>
            ...
            <h2>--lacks / -l <span class="text-body-small text-grey-darken-2">Specify forbidden amino acids</span></h2>
