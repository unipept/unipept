    ...
    <v-container>
        ...
        >
            <p>
                ...
                >
                    --all parameter
                </r-link>, this can be supplemented with the name of the <initialism>EC</initialism>-number. Consult
                the <r-link
                    to="/apidocs/pept2ec"
                    router
                >
                    <initialism>API</initialism> documentation
                </r-link> for a detailed list of output fields. A selection of
                output fields can be specified with the <r-link
                    to="#options"
                    router
                >
                    --select parameter
