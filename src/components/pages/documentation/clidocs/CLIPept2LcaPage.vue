<template>
    <v-container>
        ...
        <p>
            ...
            fetched by doing <r-link to="/apidocs/pept2lca" router><initialism>API</initialism>-requests</r-link> to the Unipept server.
        </p>
        ...
        >
            <p>
                ...
                <r-link to="#options" router>--all parameter</r-link>, this can be supplemented with the full taxonomic lineage of the <initialism>LCA</initialism>. Consult the
                <r-link to="/apidocs/pept2lca" router><initialism>API</initialism> documentation</r-link> for a detailed list of output fields. A selection of output fields can be specified
                with the <r-link to="#options" router>--select parameter</r-link>. By default, output is generated in csv format. By using the
