    ...
    <v-container>
        ...
        >
            <p>
                ...
                rank are returned. By using the <r-link
                    to="#options"
                    router
                >
                    --all parameter
                </r-link>, this can be supplemented with the full taxonomic lineage of the taxon.
                Consult the <r-link
                    to="/apidocs/pept2taxa"
                    router
                >
                    <initialism>API</initialism> documentation
                </r-link> for a detailed list of output fields. A selection of output
                fields can be specified with the <r-link
                    to="#options"
                    router
                >
                    --select parameter
                ...
                >
                    --format parameter
                </r-link>, the format can be changed into json or xml. The output can be written to a file or to <i>standard output</i>.
            </p>
        ...
        >
            ...
            <h4>Example</h4>
            <boxed>
                <sentinel>$</sentinel> unipept pept2taxa <b>--host</b> http://localhost:3000 AALTER
            </boxed>
            ...
            <h4>Example</h4>
            <boxed>
                <sentinel>$</sentinel> unipept pept2taxa <b>--quiet</b> -i peptides.txt
            </boxed>
            ...
            <h4>Example</h4>
            <boxed>
                <sentinel>$</sentinel> unipept pept2taxa <b>--log</b> unipept.log -i peptides.txt
            </boxed>
