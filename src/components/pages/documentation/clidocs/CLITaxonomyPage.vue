<template>
    <v-container>
        ...
        <p>
            ...
            these taxa as output. All this information is fetched by doing <r-link to="/apidocs/taxonomy" router><initialism>API</initialism>-requests</r-link> to
            the Unipept server.
        </p>
        ...
        >
            <p>
                ...
                rank of each taxon id are returned. By using the <r-link to="#options" router>--all parameter</r-link>, this can be supplemented with the full
                taxonomic lineage of each taxon. Consult the <r-link to="/apidocs/taxa2tree" router><initialism>API</initialism> documentation</r-link> for a detailed
                list of output fields. A selection of output fields can be specified with the <r-link to="#options" router>--select parameter</r-link>. By default,
                output is generated in csv format. By using the <r-link to="#options" router>--format parameter</r-link>, the format can be changed into json or xml.
