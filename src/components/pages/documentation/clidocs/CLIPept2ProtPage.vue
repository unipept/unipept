<template>
    <v-container>
        ...
        <p>
            ...
            as output. This information is fetched by doing <r-link to="/apidocs/pept2prot" router><initialism>API</initialism>-requests</r-link> to the Unipept server.
        </p>
        ...
        >
            <p>
                ...
                <r-link to="#options" router>--all parameter</r-link>, this can be supplemented with the name of the associated taxon and several cross referenes such
                as the the associated <initialism>EC</initialism>-numbers and <initialism>GO</initialism>-terms. Consult the
                <r-link to="/apidocs/pept2prot" router><initialism>API</initialism> documentation</r-link> for a detailed list of output fields. A selection of output fields can
                be specified with the <r-link to="#options" router>--select parameter</r-link>. By default, output is generated in csv format. By using the
                <r-link to="#options" router>--format parameter</r-link>, the format can be changed into json or xml. The output can be written to a file or to
                <i>standard output</i>.
            </p>
