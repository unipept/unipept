<template>
    <v-container>
        ...
        >
            ...
            <p>
                We can analyse the output files (<inline-code>*.tid.fa.gz</inline-code>) individually or comparatively. For the first, <initialism>UMGAP</initialism>
        ...
        >
            ...
            <image-caption-card
                class="mt-5"
                :image="CaseStudyUMGAPComparativeImage"
            />
        </header-body-card>
...
import CaseStudyUMGAPComparativeImage from '@/assets/documentation/metagenomics/casestudy-umgap-comparative.svg';
