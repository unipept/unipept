<template>
    <v-container>
        ...
        <p>
            ...
            tryptic peptide. This is the same information as provided when performing a search with the <r-link to="/tpa" router>Tryptic Peptide Analysis</r-link> in
            the web interface.
        </p>
        ...
        <HeaderBodyCard id="request" title="Request">
            <p>
                ...
                <inline-code>https://api.unipept.ugent.be/api/v1/pept2funct</inline-code>. <r-link to="#parameters" router>Parameters</r-link> can be included in the request body
