    ...
    <v-container>
        ...
        <HeaderBodyCard id="request" title="Request">
            <p>
                ...
                <inline-code>https://api.unipept.ugent.be/api/v1/pept2ec</inline-code>. <r-link to="#parameters" router>Parameters</r-link> can be included in the request body
            ...
            <p>
                ...
                <initialism>EC</initialism>-numbers associated with each of the <inline-code>input[]</inline-code> peptides based on their occurrence in UniProt entries. To pass
            ...
            <p>
                ...
                <initialism>EC</initialism>-number. See the <r-link to="#response" router>response</r-link> section for an overview of the information fields returned.
            </p>

            <StaticAlert title="Performance penalty">
                <p>
                    Setting <inline-code>extra</inline-code> to <inline-code>true</inline-code> has a performance penalty inferred from additional database queries. Do not use this parameter
