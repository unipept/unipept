<template>
    <v-container>
        ...
        <h3 class="font-weight-light">
            Returns the functional <initialism>EC</initialism>-numbers associated with a given tryptic peptide.
        </h3>

        <v-divider class="my-2" />

        <p>
            This method returns the functional <initialism>EC</initialism>-numbers associated with a given tryptic peptide.
        ...
        >
            ...
            <ul class="my-3">
                ...
                <li>
                    <inline-code>ec</inline-code>: A list of <initialism>JSON</initialism> objects that each represent an <initialism>EC</initialism>-number associated with the current tryptic peptide.
                    <ul>
                        <li>
                            <inline-code>ec_number</inline-code>: <initialism>EC</initialism>-number associated with the current tryptic peptide.
                        </li>
                        <li>
                            <inline-code>protein_count</inline-code>: amount of proteins matched with the given tryptic peptide that are labeled with the current<initialism>EC</initialism>-number.
                        </li>
                        <li>
        ...
        >
            <template #description>
                This example retrieves all functional <initialism>EC</initialism>-numbers associated with the tryptic peptide <i><initialism>AIPQLEVARPADAYETAEAYR</initialism></i>.
        ...
        >
            <template #description>
                This example retrieves the functional <initialism>EC</initialism>-numbers for both the tryptic peptides <i><initialism>AIPQLEVARPADAYETAEAYR</initialism> </i> and <i><initialism>APVLSDSSCK</initialism></i>. The result is the same as the combination of this search and this search with the Tryptic Peptide Analysis in the web interface.
            </template>
            <template #post>
        ...
        >
            <template #description>
                This example retrieves the functional <initialism>EC</initialism>-numbers associated with the tryptic peptide <i><initialism>AIPQLEVARPADAYETAEAYR</initialism></i> including the name of each <initialism>EC</initialism>-number.
                The result is the same as this search with the Tryptic Peptide Analysis in the web interface.
            </template>
            <template #post>
