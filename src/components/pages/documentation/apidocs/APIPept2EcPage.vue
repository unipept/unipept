<template>
    <v-container>
        ...
        >
            <p>
                The pept2ec method can be used by doing a <initialism>HTTP POST</initialism>-request (preferred) or <initialism>GET</initialism>-request to <inline-code>https://api.unipept.ugent.be/api/v1/pept2ec</inline-code>.
                <r-link
                    to="#parameters"
                    router
                >
