<template>
    <v-container>
        <h1 class="font-weight-light">
            <initialism>POST</initialism>
            /api/v2/pept2ec
        </h1>
        <h3 class="font-weight-light">
            Returns the functional <initialism>EC</initialism>-numbers associated with a given peptide.
        </h3>

        <v-divider class="my-2" />

        <p>
            This method returns the functional <initialism>EC</initialism>-numbers associated with a given peptide.
        ...
        >
            <p>
                The pept2ec method can be used by doing a <initialism>HTTP POST</initialism>-request (preferred) or <initialism>GET</initialism>-request to <inline-code>https://api.unipept.ugent.be/api/v2/pept2ec</inline-code>.
                <r-link
                    to="#parameters"
                    router
                >
            ...
            <p>
                ...
                Unipept will return the functional <initialism>EC</initialism>-numbers associated with each of the <inline-code>input[]</inline-code> peptides based on their occurrence in UniProt entries.
            ...
            <p>
                ...
                When not set explicitly, the parameter defaults to <inline-code>false</inline-code>.
                When the parameter is set to <inline-code>true</inline-code>, Unipept will also return the name associated with an<initialism>EC</initialism>-number.
                See the <r-link
                    to="#response"
                    router
                >
        ...
        >
            ...
            <ul class="my-3">
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            <inline-code>ec_number</inline-code>: <initialism>EC</initialism>-number associated with the current peptide.
                        </li>
                        <li>
                            <inline-code>protein_count</inline-code>: amount of proteins matched with the given peptide that are labeled with the current<initialism>EC</initialism>-number.
                        </li>
                        <li>
                            <inline-code>name</inline-code>: optional, name of the <initialism>EC</initialism>-number.
                            Included when the <inline-code>extra</inline-code> parameter is set to <inline-code>true</inline-code>.
                        </li>
                    </ul>
                </li>
            </ul>
        ...
        <example-card
            title="Retrieve the functional ec-numbers associated with a given peptide"
            :response="response1"
        >
            <template #description>
                This example retrieves all functional <initialism>EC</initialism>-numbers associated with the peptide <i><initialism>AIPQLEVARPADAYETAEAYR</initialism></i>.
                The result is the same as this search with the Single Peptide Analysis in the web interface.
            </template>
            <template #post>
                curl -X POST -H 'Accept: application/json' api.unipept.ugent.be/api/v2/pept2ec -d 'input[]=AIPQLEVARPADAYETAEAYR'
            </template>
            <template #get>
                https://api.unipept.ugent.be/api/v2/pept2ec.json?input[]=AIPQLEVARPADAYETAEAYR
            </template>
        </example-card>
        ...
        <example-card
            id="example2"
            class="mt-5"
            title="Retrieve the functional ec-numbers associated with each of multiple peptides"
            :response="response2"
        >
            <template #description>
                This example retrieves the functional <initialism>EC</initialism>-numbers for both the peptides <i><initialism>AIPQLEVARPADAYETAEAYR</initialism> </i> and <i><initialism>APVLSDSSCK</initialism></i>. The result is the same as the combination of this search and this search with the Single Peptide Analysis in the web interface.
            </template>
            <template #post>
                curl -X POST -H 'Accept: application/json' api.unipept.ugent.be/api/v2/pept2ec -d 'input[]=AIPQLEVARPADAYETAEAYR' -d 'input[]=APVLSDSSCK'
            </template>
            <template #get>
                https://api.unipept.ugent.be/api/v2/pept2ec.json?input[]=AIPQLEVARPADAYETAEAYR&input[]=APVLSDSSCK
            </template>
        </example-card>

        <example-card
            class="mt-5"
            title="Retrieve the functional ec-numbers associated with a single peptide, while equating I and L"
            :response="response3"
        >
            <template #description>
                This example retrieves the functional <initialism>EC</initialism>-numbers associated with the peptide <i><initialism>APVLSDSSCK</initialism></i>.
            ...
            <template #post>
                curl -X POST -H 'Accept: application/json' api.unipept.ugent.be/api/v2/pept2ec -d 'input[]=APVISDSSCK' -d 'equate_il=true'
            </template>
            <template #get>
                https://api.unipept.ugent.be/api/v2/pept2ec.json?input[]=APVISDSSCK&equate_il=true
            </template>
        </example-card>

        <example-card
            class="mt-5"
            title="Retrieve the functional ec-numbers associated with a single peptide, with extra information enabled"
            :response="response4"
        >
            <template #description>
                This example retrieves the functional <initialism>EC</initialism>-numbers associated with the peptide <i><initialism>AIPQLEVARPADAYETAEAYR</initialism></i> including the name of each <initialism>EC</initialism>-number.
                The result is the same as this search with the Single Peptide Analysis in the web interface.
            </template>
            <template #post>
                curl -X POST -H 'Accept: application/json' api.unipept.ugent.be/api/v2/pept2ec -d 'input[]=AIPQLEVARPADAYETAEAYR' -d 'extra=true'
            </template>
            <template #get>
                https://api.unipept.ugent.be/api/v2/pept2ec.json?input[]=AIPQLEVARPADAYETAEAYR&extra=true
            </template>
        </example-card>
