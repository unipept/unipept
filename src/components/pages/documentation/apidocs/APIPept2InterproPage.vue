<template>
    <v-container>
        ...
        <h3 class="font-weight-light">
            Returns the functional InterPro entries associated with a given peptide.
        </h3>

        <v-divider class="my-2" />

        <p>
            This method returns the functional InterPro entries associated with a given peptide.
        ...
        <example-card
            title="Retrieve the functional InterPro entries associated with a given peptide"
            :response="response1"
        >
            <template #description>
                This example retrieves all functional InterPro entries associated with the peptide <i><initialism>AIPQLEVARPADAYETAEAYR</initialism></i>.
        ...
        <example-card
            id="example2"
            class="mt-5"
            title="Retrieve the functional InterPro entries associated with each of multiple peptides"
            :response="response2"
        >
            <template #description>
                This example retrieves the functional InterPro entries for both the peptides <i><initialism>AIPQLEVARPADAYETAEAYR</initialism></i> and <i><initialism>APVLSDSSCK</initialism></i>.
        ...
        <example-card
            class="mt-5"
            title="Retrieve the functional InterPro entries associated with a single peptide, while equating I and L"
            :response="response3"
        >
            <template #description>
                This example retrieves the functional InterPro entries associated with the peptide <i><initialism>APVLSDSSCK</initialism></i>.
        ...
        <example-card
            class="mt-5"
            title="Retrieve the functional InterPro entries associated with a single peptide, with extra information enabled"
            :response="response4"
        >
            <template #description>
                This example retrieves the functional InterPro entries associated with the peptide <i><initialism>AIPQLEVARPADAYETAEAYR</initialism></i> including the name and type of each InterPro entry.
                The result is the same as this search with the Single Peptide Analysis in the web interface.
            </template>
            <template #post>
        ...
        <example-card
            class="mt-5"
            title="Retrieve the functional InterPro entries associated with a single peptide, making a distinction between different types"
            :response="response5"
        >
            <template #description>
                This example retrieves the functional InterPro entries associated with the peptide <i><initialism>APVLSDSSCK</initialism></i> distributed over the distinct InterPro types.
                The result is the same as this search with the Single Peptide Analysis in the web interface.
            </template>
            <template #post>
