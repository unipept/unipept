    ...
    <v-container>
        <v-row>
            ...
            <v-col
                ...
                lg="7"
            >
                <header-body-card title="How to cite Unipept">
                    <div class="px-2 py-4">
                        <span>
        ...
        <v-row>
            <v-col
                v-for="member in former_members"
                :key="member.name"
                sm="6"
                md="4"
            >
...
const supporters = [
    { name: "ELIXIR", imgUrl: elixirLogoImage },
    { name: "UGent", imgUrl: ugentLogoImage }
];
</script>
