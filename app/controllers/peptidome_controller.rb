class PeptidomeController < ApplicationController
  def analyze
    ...
    @genomes = Proteome.joins(:lineage).select('proteomes.organism_name as name, proteomes.id, lineages.species as species_id, lineages.genus as genus_id, lineages.order as order_id, lineages.class as class_id').uniq
