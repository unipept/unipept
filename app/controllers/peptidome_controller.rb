class PeptidomeController < ApplicationController
  ...
  def analyze
    ...
    @genomes = Assembly.joins(:lineage).select("assemblies.organism_name as name, assemblies.id, assembly_level, genome_representation, type_strain, lineages.species as species_id, lineages.genus as genus_id, lineages.order as order_id, lineages.class as class_id").uniq
