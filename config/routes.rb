UnipeptWeb::Application.routes.draw do
  ...
  match '/peptidefinder', :to => 'pancorepeptidome#analyze', :as => 'peptide_finder', defaults: { tab: 'peptidefinder' }
  match '/peptidomeclustering', :to => 'pancorepeptidome#analyze', :as => 'peptidome_clustering', defaults: { tab: 'peptidomeclustering' }
