UnipeptWeb::Application.routes.draw do
  ...
  namespace :api, path: 'umgap' do
    ...
    get 'casestudies/configured',    to: 'umgap#casestudy_configured',    as: 'umgap/casestudy_configured'
    get 'casestudies/preconfigured', to: 'umgap#casestudy_preconfigured', as: 'umgap/casestudy_preconfigured'
