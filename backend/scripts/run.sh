...
# Load Uniprot
java -cp "backend/java:backend/java/bin:backend/java/bin/:backend/java/lib/mysql.jar" -Xmx1g backend/commandline/PeptideLoader ../data/uniprot/uniprot_sprot.xml ../data/uniprot/uniprot_trembl.xml
