...
public class UniprotEntry {
    ...
    public void addInterproRef(UniprotInterproRef ref) {
        interproReferences.add(ref);
    }
    ...
    public List<UniprotInterproRef> getInterproReferences() {
        return interproReferences;
    }
